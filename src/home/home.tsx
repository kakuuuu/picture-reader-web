            ...
            <div className="space-y-8 text-left">
              <div className="space-y-4">
                <h1 className="text-5xl font-extrabold tracking-tight text-gray-900 lg:text-6xl">
                  <span className="block">Picture Reader</span>
                </h1>
                <p>
                  <span className="block bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-2xl font-extrabold text-transparent">
                    Extract Webpage Images | Image Manipulation | Slideshow
                    Playback | Image Size Filtering | Batch Download | Auto Load
                  </span>
                </p>
                <p className="max-w-2xl text-xl text-gray-600">
                  Picture Reader is a powerful browser extension that helps you
                  extract, organize, and download images from any webpage.
                  Experience seamless image management with our intuitive
                  interface.
                </p>
              </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-extrabold text-gray-900 sm:text-4xl">
              Powerful Features for Image Management
            </h2>
            <p className="mt-4 text-xl text-gray-500">
              Everything you need to efficiently handle images from any webpage
            </p>
          </div>
          <div className="mt-20 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            {[
              {
                title: 'Unified Image Browsing',
                description:
                  'Extract and view all images from any webpage in a clean, organized interface',
                icon: 'fa-images',
              },
              {
                title: 'Image Manipulation',
                description:
                  'Zoom, rotate, and navigate through images with intuitive controls',
                icon: 'fa-crop',
              },
              {
                title: 'Slideshow Playback',
                description:
                  'Automatically play through images with customizable intervals',
                icon: 'fa-play-circle',
              },
              {
                title: 'Size Filtering',
                description:
                  'Filter images based on dimensions to find exactly what you need',
                icon: 'fa-filter',
              },
              {
                title: 'Batch Download',
                description:
                  'Download multiple images simultaneously with just one click',
                icon: 'fa-download',
              },
              {
                title: 'Auto-Load',
                description:
                  'Automatically load images as you scroll through long webpages',
                icon: 'fa-sync',
              },
            ].map((feature, index) => (
              <div
            ...
            {[
              {
                ...
                description:
                  'Browse all images on a webpage in an organized grid layout',
                image: `${router.basePath}/assets/images/example1.png`,
              },
              {
                title: 'Image Details Panel',
                description:
                  'View detailed information and controls for each image',
                image: `${router.basePath}/assets/images/example2.png`,
              },
              {
                title: 'Batch Download Interface',
                description:
              ...
              },
              {
                ...
                description:
                  'Powerful tools to find exactly the images you need',
